...
namespace KnowSL.ContextDB
{
    ...
    /// </summary>
    public partial class DB_9B214B_ProductKnowledgeEntities2 : ObjectContext
    {
        #region Constructors
    
        /// <summary>
        /// Initializes a new DB_9B214B_ProductKnowledgeEntities2 object using the connection string found in the 'DB_9B214B_ProductKnowledgeEntities2' section of the application configuration file.
        /// </summary>
        public DB_9B214B_ProductKnowledgeEntities2() : base("name=DB_9B214B_ProductKnowledgeEntities2", "DB_9B214B_ProductKnowledgeEntities2")
        {
        ...
        /// <summary>
        /// Initialize a new DB_9B214B_ProductKnowledgeEntities2 object.
        /// </summary>
        public DB_9B214B_ProductKnowledgeEntities2(string connectionString) : base(connectionString, "DB_9B214B_ProductKnowledgeEntities2")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
        ...
        /// Initialize a new DB_9B214B_ProductKnowledgeEntities2 object.
        /// </summary>
        public DB_9B214B_ProductKnowledgeEntities2(EntityConnection connection) : base(connection, "DB_9B214B_ProductKnowledgeEntities2")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
    ...
    /// No Metadata Documentation available.
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="KSLDatabaseEntityContext", Name="Ingredient")]
    [Serializable()]
    ...
    /// No Metadata Documentation available.
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="KSLDatabaseEntityContext", Name="IngredientDescription")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    ...
    /// No Metadata Documentation available.
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="KSLDatabaseEntityContext", Name="IngredientDescriptionType")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    ...
    /// No Metadata Documentation available.
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="KSLDatabaseEntityContext", Name="NewsLetter")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    ...
    /// No Metadata Documentation available.
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="KSLDatabaseEntityContext", Name="Product")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    ...
    /// No Metadata Documentation available.
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="KSLDatabaseEntityContext", Name="ProductIngredientLink")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
